...
static uint8_t * parse_msgc_main_power_event_request(uint8_t *message_start, uint8_t *message_end, SPICE_GNUC_UNUSED int minor, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    size_t mem_size;
    uint8_t *in, *end;
    SpiceMsgcMainPowerEventRequest *out;

    nw_size = 4;
    mem_size = sizeof(SpiceMsgcMainPowerEventRequest);
    ...
    end = data + sizeof(SpiceMsgcMainPowerEventRequest);
    in = start;

    out = (SpiceMsgcMainPowerEventRequest *)data;

    out->event_id = consume_uint32(&in);
...
static uint8_t * parse_MainChannel_msgc(uint8_t *message_start, uint8_t *message_end, uint16_t message_type, SPICE_GNUC_UNUSED int minor, size_t *size_out, message_destructor_t *free_message)
{
    ...
    static parse_msg_func_t funcs2[12] =  {
        ...
        parse_SpiceMsgEmpty,
        parse_msgc_main_power_event_request
    };
