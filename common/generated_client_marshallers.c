...
static void spice_marshall_msgc_main_power_event_request(SPICE_GNUC_UNUSED SpiceMarshaller *m, SPICE_GNUC_UNUSED SpiceMsgcMainPowerEventRequest *msg)
{
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgcMainPowerEventRequest *src;
    src = (SpiceMsgcMainPowerEventRequest *)msg;

    spice_marshaller_add_uint32(m, src->event_id);
}
...
static void SpiceMarshallMsgDisplayStreamConfig(SPICE_GNUC_UNUSED SpiceMarshaller *m, SPICE_GNUC_UNUSED SpiceMsgDisplayStreamConfig *msg);
static void SpiceMarshallMsgDisplayStreamStatData(SPICE_GNUC_UNUSED SpiceMarshaller *m, SPICE_GNUC_UNUSED SpiceMsgDisplayStreamStatData *msg);
#endif
...
SpiceMessageMarshallers * spice_message_marshallers_get(void)
{
    ...
    marshallers.msgc_main_power_event_request = spice_marshall_msgc_main_power_event_request;
...
#ifdef FUSIONDATA_DEV
    /* add by yhoon17, 20180329 : message */
    marshallers.msg_display_stream_config = SpiceMarshallMsgDisplayStreamConfig;
    marshallers.msg_display_stream_stat_data = SpiceMarshallMsgDisplayStreamStatData;
#endif
    return &marshallers;
}
...
#ifdef FUSIONDATA_DEV
/**************************************************
 * FUSIONDATA 개발 Functions
 **************************************************/

/*
 * Description : StreamConfig message
 * Date        : 20180329
 */
static void SpiceMarshallMsgDisplayStreamConfig(SPICE_GNUC_UNUSED SpiceMarshaller *m, SPICE_GNUC_UNUSED SpiceMsgDisplayStreamConfig *msg)
{
    ...
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgDisplayStreamConfig *src;


    src = (SpiceMsgDisplayStreamConfig *)msg;

    spice_marshaller_add_int32(m, src->nStreamPort);
    spice_marshaller_add_uint32(m, src->unStreamOnMovieDetection);
    spice_marshaller_add_uint32(m, src->unOnVariationCapture);
    spice_marshaller_add_uint32(m, src->unMaxSamplingFps);
}


/*
 * Description : StreamStatData message
 * Date        : 20180329
 */
static void SpiceMarshallMsgDisplayStreamStatData(SPICE_GNUC_UNUSED SpiceMarshaller *m, SPICE_GNUC_UNUSED SpiceMsgDisplayStreamStatData *msg)
{
    //g_message("%s",__FUNCTION__);
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgDisplayStreamStatData *src;


    src = (SpiceMsgDisplayStreamStatData *)msg;

    spice_marshaller_add_uint32(m, src->unStreamBacklogSize);
}
#endif
